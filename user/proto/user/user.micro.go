...
func (c *userService) QueryUserByName(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.name, "UserService.QueryUserByName", in)
	out := new(Response)
...
func (h *userServiceHandler) QueryUserByName(ctx context.Context, in *Request, out *Response) error {
	return h.UserServiceHandler.QueryUserByName(ctx, in, out)
}
